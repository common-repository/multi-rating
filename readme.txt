...
Tags: rating, review, post rating, star rating, 5 star
...
A powerful post rating / review system plugin for WordPress. Easily add 5 star ratings to your posts.

== Description ==

A powerful post rating / review system plugin for WordPress with a niche of doing multi ratings better than anyone else. Easily add 5 star ratings to your posts.
...
= 5.0.6 (19/12/2022) =
* Fix: Added nonces to tools to prevent CSRF attack
* Fix: XSS fixes

= 5.0.5 =
* Minor changes e.g. readme
