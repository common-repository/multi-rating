	...
	function extra_tablenav( $which ) {
		...
		if ( $which == "top" ) {
			...
			<div class="alignleft filters">
				<input type="text" class="date-picker" autocomplete="off" name="from-date" placeholder="From - yyyy-MM-dd" id="from-date" value="<?php echo esc_html( $from_date ); ?>" />
				<input type="text" class="date-picker" autocomplete="off" name="to-date" placeholder="To - yyyy-MM-dd" id="to-date" value="<?php echo esc_html( $to_date ); ?>" />
			...
			case MR_Rating_Entry_Table::RATING_RESULT_COLUMN :
				...
				<div class="row-actions">
					...
					if ( current_user_can( 'manage_options' ) ) {
						?>
						<span class="edit">
							<a href="<?php echo esc_url( $edit_rating_url ); ?>"><?php _e( 'Edit Rating', 'multi-rating' ); ?></a>
						</span>
						<?php
					}
					?>
