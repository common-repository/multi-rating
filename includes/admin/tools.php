			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<form method="post" id="export-rating-results-form">
						...
						<?php wp_nonce_field( 'export-rating-results' ); ?>
				...
				<div class="postbox">
					...
					<div class="inside">
						...
						<form method="post" id="clear-database-form">
							...
							<?php wp_nonce_field( 'clear-database' ); ?>
				...
				<div class="postbox">
					...
					<div class="inside">
						...
						<form method="post" id="clear-cache-form">
							...
							<?php wp_nonce_field( 'clear-cache' ); ?>
						</form>
					</div><!-- .inside -->
				</div>
			</div>
